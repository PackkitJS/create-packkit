...
[![CI](https://img.shields.io/github/actions/workflow/status/PackkitLabs/create-packkit-js/ci.yml?style=flat-square&logo=github&label=CI&branch=main)](https://github.com/PackkitLabs/create-packkit-js/actions/workflows/ci.yml)
...
[![MCP server](https://img.shields.io/badge/MCP-packkit--mcp-8a5cf6?style=flat-square)](https://github.com/PackkitLabs/packkit-mcp)
[![llms.txt](https://img.shields.io/badge/llms.txt-✓-000000?style=flat-square)](https://packkitlabs.github.io/create-packkit-js/llms.txt)
...
There's also an [`llms.txt`](llms.txt) (served at [packkitlabs.github.io/create-packkit-js/llms.txt](https://packkitlabs.github.io/create-packkit-js/llms.txt)) describing the commands for LLMs.

**MCP server** — [`packkit-mcp`](https://github.com/PackkitLabs/packkit-mcp) exposes every Packkit generator (JS/TS + Python) as native [Model Context Protocol](https://modelcontextprotocol.io) tools. Add to your agent's MCP config:
